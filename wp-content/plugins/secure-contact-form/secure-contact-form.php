...
// Activation Hook
function secure_contact_form_activate() {
    add_option('secure_contact_form_activated', true);
}
register_activation_hook(__FILE__, 'secure_contact_form_activate');

// Deactivation Hook
function secure_contact_form_deactivate() {
    delete_option('secure_contact_form_activated');
}
register_deactivation_hook(__FILE__, 'secure_contact_form_deactivate');

function secure_contact_form_enqueue_styles() {
    wp_enqueue_style(
        'secure-contact-form-style', 
...
add_action('wp_enqueue_scripts', 'secure_contact_form_enqueue_styles');


// Add Admin Menu
function secure_contact_form_menu() {
    add_menu_page(
        'Secure Contact Form',
        'Contact Form',
        'manage_options',
...
// Admin Page Content
function secure_contact_form_admin_page() {
    ?>
    <div class="wrap">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <form method="post" action="" class="secure-contact-form">
            ...
            <div style="text-align: center; margin-top: 20px;">
                <button name="submit_contact_form" type="submit" class="btn btn-primary" tabIndex="-1">Send message</button>
            </div>
        </form>
